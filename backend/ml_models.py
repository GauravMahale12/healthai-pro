...
model = joblib.load(
    os.path.join(ML_FOLDER, "disease_model.pkl")
)

symptom_encoder = joblib.load(
    os.path.join(ML_FOLDER, "symptom_encoder.pkl")
)

label_encoder = joblib.load(
    os.path.join(ML_FOLDER, "label_encoder.pkl")
)
...
def predict_disease(data):
    ...
    if (
        ...
        return {
            ...
            "risk_score": "82/100",
            "doctor_recommendation": (
                "Urgent Physician Visit + CBC Test"
            ),
            "note": (
    ...
    if (
        ...
        return {
            ...
            "note": (
                "Doctor consultation is strongly recommended."
            )
        }
    ...
    if (
        ...
        return {
            ...
            "note": (
                "Breathing issues should not be ignored."
            )
        }
    ...
    if (
        ...
        return {
            ...
            "risk_score": "60/100",
            "doctor_recommendation": (
                "Visit General Physician / Neurologist"
            ),
            "note": (
